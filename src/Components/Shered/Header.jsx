...
const Header = () => {
    ...
    return (
        <div className='w-full py-4 bg-[var(--color-7)] end-center  gap-4 pr-2 box-border'>
            ...
            <div style={{boxShadow: "0px 0px 10px 2px rgba(0,0,0,0.24)"}} onClick={()=>navigate('/profile')} className='end-center gap-1 border-gray-400 p-[2px] px-4 rounded-md cursor-pointer'>
